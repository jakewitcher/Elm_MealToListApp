...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{amount: 0, grocery: '', groceryList: _List_Nil, groceryListAll: _List_Nil, item: '', itemList: _List_Nil, meal: '', mealList: _List_Nil, selectedGrocery: _List_Nil, selectedMeal: _List_Nil, unit: ''},
...
var author$project$Main$findMeal = function (model) {
	return A2(
		...
		function (meal) {
			return _Utils_eq(meal.name, model.meal);
		},
		model.mealList);
};
...
var author$project$Main$findSelectedGrocery = F2(
	function (model, name) {
		return A2(
			elm$core$List$filter,
			function (grocery) {
				return _Utils_eq(name, grocery.name);
			},
			model.groceryListAll);
	});
			...
			case 'SelectMeal':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selectedMeal: A2(author$project$Main$findSelectedMeal, model, meal)
						}),
					elm$core$Platform$Cmd$none);
			case 'SelectGrocery':
				var grocery = msg.a;
	...
	return A2(
		...
		function (grocery) {
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text(grocery.name)
					]));
		},
		model.groceryListAll);
};
...
var author$project$Main$groceryList = function (model) {
	return A2(
		elm$html$Html$ul,
		_List_Nil,
		A2(elm$core$List$map, author$project$Main$itemMod, model.groceryList));
};
			...
			A3(
				...
				F2(
					function (grocery, list) {
						return _Utils_ap(grocery.items, list);
					}),
				_List_Nil,
				model.selectedGrocery)));
};
	...
	return A2(
		...
		A2(
			...
			A3(
				...
				F2(
					function (meal, list) {
						return _Utils_ap(meal.itemList, list);
					}),
				_List_Nil,
				model.selectedMeal)));
};

...
{
	if (region.Y.M === region.ad.M)
	{
		return 'on line ' + region.Y.M;
	}
	return 'on lines ' + region.Y.M + ' through ' + region.ad.M;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aE: 'hidden', L: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aE: 'mozHidden', L: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aE: 'msHidden', L: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aE: 'webkitHidden', L: 'webkitvisibilitychange' }
		: { aE: 'hidden', L: 'visibilitychange' };
}
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{f: 0, C: '', x: _List_Nil, r: _List_Nil, E: '', k: _List_Nil, s: '', l: _List_Nil, i: _List_Nil, j: _List_Nil, n: ''},
...
var author$project$Main$convertToDictAndSumAmount = function (meals) {
	var newDict = elm$core$Dict$empty;
	return A3(
		elm$core$List$foldl,
		F2(
			function (item, dict) {
				...
				return A2(elm$core$Dict$member, itemKey, dict) ? A3(
					...
					dict) : A3(elm$core$Dict$insert, itemKey, item, dict);
			}),
		newDict,
		meals);
};
...
var author$project$Main$findMeal = function (model) {
	return A2(
		elm$core$List$filter,
		function (meal) {
			return _Utils_eq(meal.a, model.s);
		},
		model.l);
};
...
var author$project$Main$createGrocery = function (model) {
	var newGrocery = A2(
		...
		author$project$Main$formatString(model.C),
		model.x);
	var newGroceryList = A2(elm$core$List$cons, newGrocery, model.r);
	return _Utils_update(
		model,
		{C: '', x: _List_Nil, r: newGroceryList});
};
var author$project$Main$Item = F3(
	function (name, amount, unit) {
		return {f: amount, a: name, n: unit};
	});
		...
		model,
		{
			...
			k: A2(
				...
				A3(
					...
					author$project$Main$formatString(model.E),
					model.f,
					model.n),
				model.k),
			n: ''
...
var author$project$Main$Meal = F2(
	function (name, itemList) {
		return {k: itemList, a: name};
	});
var author$project$Main$createMeal = function (model) {
	var newMeal = A2(
		author$project$Main$Meal,
		author$project$Main$formatString(model.s),
		model.k);
	var newMealList = A2(elm$core$List$cons, newMeal, model.l);
	return _Utils_update(
		model,
		{k: _List_Nil, s: '', l: newMealList});
};
...
var author$project$Main$findAndReplaceUpdatedGrocery = function (model) {
	...
	var filteredList = A2(
		elm$core$List$filter,
		function (grocery) {
			return !_Utils_eq(grocery.a, groceryName);
		},
		model.r);
	var newList = _Utils_ap(filteredList, model.i);
	return _Utils_update(
		model,
		{r: newList});
};
...
var author$project$Main$findAndReplaceUpdatedMeal = function (model) {
	...
	var filteredList = A2(
		elm$core$List$filter,
		function (meal) {
			return !_Utils_eq(meal.a, mealName);
		},
		model.l);
	var newList = _Utils_ap(filteredList, model.j);
	return _Utils_update(
		model,
		{l: newList});
};
...
var author$project$Main$findSelectedGrocery = F2(
	function (model, name) {
		return A2(
			elm$core$List$filter,
			function (grocery) {
				return _Utils_eq(name, grocery.a);
			},
			model.r);
	});
var author$project$Main$findSelectedMeal = F2(
	function (model, name) {
		return A2(
			elm$core$List$filter,
			function (meal) {
				return _Utils_eq(name, meal.a);
			},
			model.l);
	});
			...
			case 9:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: A2(author$project$Main$findSelectedMeal, model, meal)
						}),
					elm$core$Platform$Cmd$none);
			case 10:
				var grocery = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							i: A2(author$project$Main$findSelectedGrocery, model, grocery)
						}),
					elm$core$Platform$Cmd$none);
			case 11:
				return _Utils_Tuple2(
...
var author$project$Main$endBreak = A2(
	...
	_List_Nil);
var author$project$Main$AddMeal = {$: 6};
...
var author$project$Main$SaveGrocery = {$: 8};
var elm$html$Html$option = _VirtualDom_node('option');
var elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var elm$html$Html$text = elm$virtual_dom$VirtualDom$text;
var author$project$Main$mealSelect = function (model) {
	return A2(
		elm$core$List$map,
		function (meal) {
			return A2(
...
var author$project$Main$SelectGrocery = function (a) {
	return {$: 10, a: a};
};
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						author$project$Main$SelectGrocery(grocery.a)),
						elm$html$Html$Attributes$class('meal-grocery-list')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(grocery.a)
					]));
		},
		model.r);
};
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								elm$core$String$fromFloat(item.f))
							]))
					])),
				A2(
				elm$html$Html$div,
...
var author$project$Main$groceryList = function (model) {
	return A2(
		elm$html$Html$ul,
		_List_Nil,
		A2(elm$core$List$map, author$project$Main$itemMod, model.x));
};
...
var author$project$Main$grocerySection = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				author$project$Main$groceryList(model)
			]));
};
var author$project$Main$itemList = function (model) {
	return A2(
		elm$html$Html$ul,
		_List_Nil,
		A2(elm$core$List$map, author$project$Main$itemMod, model.k));
};
...
var author$project$Main$lineBreak = A2(
	...
	_List_Nil);
var author$project$Main$AddItem = {$: 5};
var author$project$Main$InputAmount = function (a) {
	return {$: 1, a: a};
};
var author$project$Main$InputItem = function (a) {
	return {$: 0, a: a};
};
var author$project$Main$InputUnit = function (a) {
	return {$: 2, a: a};
};
var author$project$Main$SaveMeal = {$: 7};
								...
								_List_fromArray(
									[
										...
										author$project$Main$formatString(
											elm$core$String$fromFloat(model.f)))
									]),
								_List_Nil),
								A2(
								elm$html$Html$select,
...
var author$project$Main$SelectMeal = function (a) {
	return {$: 9, a: a};
};
		...
		function (meal) {
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(
						author$project$Main$SelectMeal(meal.a)),
						elm$html$Html$Attributes$class('meal-grocery-list')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(meal.a)
					]));
		},
		model.l);
};
			...
			A3(
				...
				F2(
					function (grocery, list) {
						return _Utils_ap(grocery.U, list);
					}),
				_List_Nil,
				model.i)));
};
var author$project$Main$selectedGroceryBody = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Main$CancelSelectedGrocery = {$: 12};
		...
		_List_fromArray(
			[
				...
				A2(
					elm$core$List$map,
					function (grocery) {
						return elm$html$Html$text(grocery.a);
					},
					model.i)),
				A2(
				elm$html$Html$h2,
...
var author$project$Main$selectedGrocery = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$selectedGroceryName(model),
	...
	return A2(
		...
		A2(
			...
			A3(
				...
				F2(
					function (meal, list) {
						return _Utils_ap(meal.k, list);
					}),
				_List_Nil,
				model.j)));
};
var author$project$Main$selectedMealBody = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Main$CancelSelectedMeal = {$: 11};
		...
		_List_fromArray(
			[
				...
				A2(
					elm$core$List$map,
					function (meal) {
						return elm$html$Html$text(meal.a);
					},
					model.j)),
				A2(
				elm$html$Html$h2,
...
var author$project$Main$selectedMeal = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$selectedMealName(model),
				author$project$Main$selectedMealBody(model)
			]));
};
	...
	return {
		aa: _List_fromArray(
			[
				...
				(!_Utils_eq(model.j, _List_Nil)) ? author$project$Main$selectedMeal(model) : A2(
				elm$html$Html$div,
				_List_fromArray(
					[
				...
				(!_Utils_eq(model.i, _List_Nil)) ? author$project$Main$selectedGrocery(model) : A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$hidden(true)
...
var author$project$Main$main = elm$browser$Browser$document(
	{aG: author$project$Main$init, aL: author$project$Main$subscriptions, aM: author$project$Main$update, aO: author$project$Main$view});
